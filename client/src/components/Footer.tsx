    ...
    <footer className="bg-[var(--color-primary-dark)] text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Social Media */}
          <div>
            <h3 className="font-bold text-lg mb-3">{t("social")}</h3>
            <div className="flex flex-col gap-2">
              <a
                href="https://www.instagram.com/korvoni_umed/"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/korvoni.umed/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-white/80 hover:text-white transition-colors flex items-center gap-2"
              >
        ...
        <div className="border-t border-white/20 mt-8 pt-6 text-center text-sm text-white/60">
          Korvoni Umed &copy; {new Date().getFullYear()}. {t("rights")}
        </div>
      </div>
    </footer>
  );
